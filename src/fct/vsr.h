...
#define VSR_STAT_INC(_name) bts_u64_inc(_name)
#define VSR_STAT_DEC(_name) bts_u64_dec(_name)
#define VSR_STAT_SET(_name, _val) bts_u64_set(_name,  _val)

#define VSR_SPINLOCK_LOCK(_lock) bts_lock_lock(_lock)
#define VSR_SPINLOCK_UNLOCK(_lock) bts_lock_unlock(_lock)
#define VSR_SPINLOCK_INIT(_lock) bts_lock_init(_lock)

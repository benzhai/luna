...
inline void pid_incr_count(enum pid_pkt_type pid_type) 
{
    ...
    {
          return  bts_u64_inc(&(gpid_stats[pid_type].stat));      
    }
    else
    {
        ;
...
/*    
    ...
    {
        case OUTERL3_IPV4:
               return  bts_u64_inc(&gpid_stats.st_outerl3_ip4);            
        case OUTERL3_IPV6:
               return  bts_u64_inc(&gpid_stats.st_outerl3_ip6);
        case OUTERL3_NOIP:
               return  bts_u64_inc(&gpid_stats.st_outerl3_noip);             
        case OUTERL4_TCP:
               return bts_u64_inc(&gpid_stats.st_outerl4_tcp);  
        case OUTERL4_UDP:
               return bts_u64_inc(&gpid_stats.st_outerl4_udp);
        case OUTERL4_OTHER:
               return bts_u64_inc(&gpid_stats.st_outerl4_other);

        case INNERL3_IPV4:
                return bts_u64_inc(&gpid_stats.st_innerl3_ip4);
        case INNERL3_IPV6:
                return bts_u64_inc(&gpid_stats.st_innerl3_ip6);
        case INNERL3_NOIP:
                return bts_u64_inc(&gpid_stats.st_innerl3_noip);
        case INNERL4_TCP:
                return bts_u64_inc(&gpid_stats.st_innerl4_tcp);  
        case INNERL4_UDP:
                return bts_u64_inc(&gpid_stats.st_innerl4_udp);
        case INNERL4_OTHER:
                return bts_u64_inc(&gpid_stats.st_innerl4_other);
        case GTP_U:
                return bts_u64_inc(&gpid_stats.st_gtp_u);
        case HTTP:
                return bts_u64_inc(&gpid_stats.st_inner_and_outer_l5_http);
    }
 */   
    return;
}
